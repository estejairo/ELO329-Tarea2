public class Controller {
   private TrafficLight pedestrianPlaceres, pedestrianMatta, matta, placeresvina, placeresvalpo, giro;
   ...
   public Controller(TrafficLight m, TrafficLight p, TrafficLight placval, TrafficLight placvin,  TrafficLight mt, TrafficLight g, DetectorRequerimiento b, DetectorRequerimiento mb, DetectorRequerimiento s) {
      matta = m;
      pedestrianPlaceres = p;
      pedestrianMatta = mt;
      placeresvina = placvin;
      placeresvalpo = placval;
      giro = g;
      botonplaceres = b;
      botonmatta= mb;
      sensorInductivo = s;
